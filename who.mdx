...
Currently, the only cool thing on the site is my Game Boy emulator named <Link target="_blank" rel="noopener noreferrer" className="SubColor underline" href="https://nyah.dev/GMu">GMu.</Link> There is even
